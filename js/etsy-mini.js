...
/*eslint-disable*/
window.Etsy && window.Etsy.Logger
    ? window.Etsy.Logger.error("[JS_CULL] etsy_mini_shop - this should never fire.")
    : (function() {
          var img = new Image();
          img.src = "https://www.etsy.com/images/1x1.gif?JS_CULL=etsy_mini_shop";
      })();
